...
export default function (config) {
  ...
  Chart.drawLegend = function () {
    ...
    let lWidth = legendBox.node().getBoundingClientRect().width * 0.7;
    ...
    let lbWidth = legendBox.node().getBoundingClientRect().width * 0.85;
    ...
    if ( vm._config.legendType === 'checkbox') {
      ...
      //cut label text if text size exceeds 80% of container
      let lbWidth = legendBox.node().getBoundingClientRect().width;
