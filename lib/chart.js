...
export default function Chart(config) {
  ...
  Chart.loadData = function() {
    ...
    if (
      vm._config.plotOptions &&
      vm._config.plotOptions.bars &&
      vm._config.plotOptions.bars.averageLines &&
      Array.isArray(vm._config.plotOptions.bars.averageLines) &&
  ...
  Chart.drawAxes = function() {
    ...
    if (
      ...
      if (vm._config.yAxis && vm._config.yAxis.text) {
        console.log('yaxis', vm._config.yAxis.text);
        yAxis
          .append('text')
      ...
      if (vm._config.yAxis && vm._config.yAxis.scaleText) {
        console.log('yaxis', vm._config.yAxis.scaleText);
        yAxis
          .append('text')
    ...
    if (vm._config.xAxis && vm._config.xAxis.text && vm._xAxis) {
      vm._xAxis
        .append('text')
        .attr('class', 'axis-title')
        .attr('x', vm._width / 2)
