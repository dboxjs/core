...
export default function(config) {
  ...
  Chart.drawLegend = function(){
    ...
    legendBox.append("text")
      ...
      console.log(legendBox.node().getBoundingClientRect().width);


    var legend = legendBox.selectAll(".legend")
      .data(vm._scales.color.range())
      .enter().append("g")
      .attr("class", "legend")
    ...
    legend.append("rect")
      ...
      .attr("width", 18)
      .attr("height", 18)
      .style("fill", function(d, i) {return vm._scales.color.range().slice().reverse()[i];});
