...
export default function(config) {
  ...
  function Chart(config){
    ...
    vm.api =  {
      ...
      utils:{
        generateScale : vm.generateScale
      }
    }
  }
  //------------------------
  ...
  Chart.prototype.legend = function(legend) {
    var vm = this;
  ...
  Chart.prototype.setScales = function(scales){
  ...
  Chart.prototype.drawLegend = function(){
    ...
    // Draw legend
    var legend = vm._fullSvg.selectAll(".legend")
      .data(vm._config.colorScale)
      .enter().append("g")
      .attr("class", "legend")
      .attr("transform", function(d, i) {return "translate("+(vm._config.size.width-vm._config.size.margin.right+5) +"," + i * 19 + ")"; });

    legend.append("rect")
      .attr("x",0)
      .attr("width", 18)
      .attr("height", 18)
      .style("fill", function(d, i) {return vm._config.colorScale.slice().reverse()[i];});
    ...
    legend.append("text")
      ...
      .text(function(d,i){
          ...
          return vm._config.legend.call(this, d, i);
      });
  ...
  Chart.prototype.updateAxis = function(axis, value){
    var vm = this;
